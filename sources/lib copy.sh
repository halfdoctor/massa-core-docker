...
BuyOrSellRoll() {
	...
	green "DEBUG" "Rolls: Candidate: $CandidateRolls, Final: $Rolls, Active: $ActiveRolls, Target: $targetRollAmount, MINIMALFEE: $MINIMAL_FEE"
	...
	function buy_rolls {
		...
		echo "MINIMAL_FEE is: $MINIMAL_FEE"
		green "INFO" "Buying $rolls_to_buy roll(s) with ${MINIMAL_FEE:-undefined fee} massa..."
	...
	function sell_rolls {
		...
		green "INFO"  "Selling $rolls_to_sell roll(s) with $MINIMAL_FEE massa..."
